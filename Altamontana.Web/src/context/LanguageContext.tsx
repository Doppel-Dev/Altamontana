...
export const translations: Translations = {
  ...
  recruit: { es: 'RECLUTA', en: 'RECRUIT', pt: 'RECRUTA' },
  recruits: { es: 'RECLUTAS', en: 'RECRUITS', pt: 'RECRUTAS' },
  ...
  exploreMission: { es: 'Explorar Misión', en: 'Explore Mission', pt: 'Explorar Missão' },
  initiateReserve: { es: 'Iniciar Reserva', en: 'Initiate Reservation', pt: 'Iniciar Reserva' },
  reserveYourMission: { es: 'Reserve su Misión', en: 'Reserve your Mission', pt: 'Reserve sua Missão' },
  ...
  missionCost: { es: 'Costo de la Misión', en: 'Mission Cost', pt: 'Custo da Missão' },
