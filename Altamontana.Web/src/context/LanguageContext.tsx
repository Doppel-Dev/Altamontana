...
export const translations: Translations = {
  ...
  aviationDivision: { es: 'DIVISIÓN DE AVIACIÓN PRIVADA', en: 'PRIVATE AVIATION DIVISION', pt: 'DIVISÃO DE AVIAÇÃO PRIVADA' },
  santiagoFromAir: { es: 'Santiago Desde el Aire', en: 'Santiago From the Air', pt: 'Santiago do Ar' },
  mountainExperiences: { es: 'EXPERIENCIAS DE ALTA MONTAÑA', en: 'HIGH MOUNTAIN EXPERIENCES', pt: 'EXPERIÊNCIAS DE ALTA MONTANHA' },
  homeHeroSub: { es: 'Experiencias en helicóptero, expediciones a los Andes y aviación de lujo en Chile.', en: 'Helicopter experiences, Andes expeditions, and luxury aviation in Chile.', pt: 'Experiências em helicóptero, expedições aos Andes e aviação de luxo no Chile.' },
  exploreTours: { es: 'Explorar Tours', en: 'Explore Tours', pt: 'Explorar Tours' },
  directContact: { es: 'Contacto Directo', en: 'Direct Contact', pt: 'Contato Direto' },
  eliteStandards: { es: 'Estándares de Elite', en: 'Elite Standards', pt: 'Padrões de Elite' },
  eliteStandardsSub: { es: 'Protocolos de seguridad y servicio de aviación internacional.', en: 'International aviation safety and service protocols.', pt: 'Protocolos de segurança e serviço de aviação internacional.' },
  modernFleet: { es: 'Flota Moderna', en: 'Modern Fleet', pt: 'Frota Moderna' },
  modernFleetDesc: { es: 'Aeronaves Airbus y Bell mantenidas bajo estándares de excelencia.', en: 'Airbus and Bell aircraft maintained under standards of excellence.', pt: 'Aeronaves Airbus e Bell mantidas sob padrões de excelência.' },
  expertPilots: { es: 'Pilotos Expertos', en: 'Expert Pilots', pt: 'Pilotos Especialistas' },
  expertPilotsDesc: { es: 'Comandantes con miles de horas de vuelo en montaña y ciudad.', en: 'Commanders with thousands of flight hours in mountain and city.', pt: 'Comandantes com milhares de horas de voo em montanha e cidade.' },
  exclusiveLuxury: { es: 'Lujo Exclusivo', en: 'Exclusive Luxury', pt: 'Luxo Exclusivo' },
  exclusiveLuxuryDesc: { es: 'Experiencias personalizadas con catering y servicio premium.', en: 'Personalized experiences with catering and premium service.', pt: 'Experiências personalizadas com catering e serviço premium.' },
  catalogTitle: { es: 'Nuestras Experiencias', en: 'Our Experiences', pt: 'Nossas Experiências' },
  catalogSub: { es: 'Una selección exclusiva de misiones diseñadas para explorar la Cordillera de los Andes.', en: 'An exclusive selection of missions designed to explore the Andes Mountains.', pt: 'Uma seleção exclusiva de missões projetadas para explorar a Cordilheira dos Andes.' },
  ...
  accountingDate: { es: 'Contable', en: 'Accounting', pt: 'Contábil' },
  recruit: { es: 'PASAJERO', en: 'PASSENGER', pt: 'PASSAGEIRO' },
  recruits: { es: 'PASAJEROS', en: 'PASSENGERS', pt: 'PASSAGEIROS' },
  passenger: { es: 'PASAJERO', en: 'PASSENGER', pt: 'PASSAGEIRO' },
  passengersLabel: { es: 'PASAJEROS', en: 'PASSENGERS', pt: 'PASSAGEIROS' },
  ...
  downloadVoucher: { es: 'Descargar Voucher', en: 'Download Voucher', pt: 'Baixar Voucher' },
  ...
  exploreMission: { es: 'Explorar Experiencia', en: 'Explore Experience', pt: 'Explorar Experiência' },
  initiateReserve: { es: 'Iniciar Reserva', en: 'Initiate Reservation', pt: 'Iniciar Reserva' },
  reserveYourMission: { es: 'Reserve su Experiencia', en: 'Reserve your Experience', pt: 'Reserve sua Experiência' },
  selectDate: { es: 'Seleccionar Fecha', en: 'Select Date', pt: 'Selecionar Data' },
  participants: { es: 'Participantes', en: 'Participants', pt: 'Participantes' },
  meetingPoint: { es: 'Punto de Encuentro', en: 'Meeting Point', pt: 'Ponto de Encontro' },
  flightSummary: { es: 'Resumen de Vuelo', en: 'Flight Summary', pt: 'Resumo do Voo' },
  step: { es: 'PASO', en: 'STEP', pt: 'PASSO' },
  finalAuth: { es: 'Autorización Final', en: 'Final Authorization', pt: 'Autorização Final' },
  processing: { es: 'Procesando...', en: 'Processing...', pt: 'Processando...' },
  missionCost: { es: 'Costo de la Experiencia', en: 'Experience Cost', pt: 'Custo da Experiência' },
  airportTaxes: { es: 'Tasas e Impuestos', en: 'Taxes & Fees', pt: 'Taxas e Impostos' },
  includedShort: { es: 'INCLUIDO', en: 'INCLUDED', pt: 'INCLUÍDO' },
  securityNotice: { es: 'LAS TRANSACCIONES SE PROCESAN MEDIANTE PASARELAS CIFRADAS PARA MÁXIMA SEGURIDAD.', en: 'TRANSACTIONS ARE PROCESSED THROUGH ENCRYPTED GATEWAYS FOR MAXIMUM SECURITY.', pt: 'AS TRANSAÇÕES SÃO PROCESSADAS POR GATEWAYS CRIPTOGRAFADOS PARA MÁXIMA SEGURANÇA.' },
  usdEquivalent: { es: 'EQUIVALENTE EN USD', en: 'USD EQUIVALENT', pt: 'EQUIVALENTE EM USD' },
  preparingCheckout: { es: 'PREPARANDO RESERVA', en: 'PREPARING CHECKOUT', pt: 'PREPARANDO RESERVA' },
  ...
  notFoundDesc: { es: 'La ruta que intentas sobrevolar no existe o ha sido movida de coordenadas.', en: 'The route you are trying to fly over does not exist or has been moved from coordinates.', pt: 'A rota que você está tentando sobrevoar não existe ou foi movida de coordenadas.' },
  returnToBase: { es: 'Volver a la Base', en: 'Return to Base', pt: 'Voltar à Base' },
  statusOutOfBounds: { es: 'Estado: Fuera de límites', en: 'Status: Out of bounds', pt: 'Status: Fora de limites' },
  signalLost: { es: 'SEÑAL PERDIDA', en: 'SIGNAL LOST', pt: 'SINAL PERDIDA' },
