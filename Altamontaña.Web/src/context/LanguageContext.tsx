...
export const translations: Translations = {
  ...
  experiences: { es: 'Vuelos', en: 'Flights', pt: 'Voos' },
  ...
  viewCatalog: { es: 'Ver Vuelos', en: 'View Flights', pt: 'Ver Voos' },
  ...
  // Confirmation
  confTitle: { es: 'Vuelo Confirmado', en: 'Flight Confirmed', pt: 'Voo Confirmado' },
  confSub: { es: 'Hemos enviado los detalles a', en: 'We have sent the details to', pt: 'Enviamos os detalhes para' },
  flightExp: { es: 'Experiencia de Vuelo', en: 'Flight Experience', pt: 'Experiência de Voo' },
  ...
  loadingDark: { es: 'Iniciando Sistemas de Vuelo...', en: 'Starting Flight Systems...', pt: 'Iniciando Sistemas de Voo...' },
